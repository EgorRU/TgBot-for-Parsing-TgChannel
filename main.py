...
from updateDB import add_channel, remove_channel, delete_channel_from_user
...
async def delete(message: Message):
    await delete_channel_from_user(message.from_user.id)
